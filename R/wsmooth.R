setGeneric(name = "base_smooth", def = function(Object, penalty, lambda) {
...
setGeneric(name = "method_smooth", def = function(Object, penalty, lambda) {
